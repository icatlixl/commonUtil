...
public class Reflections {
	...
	public static Object invokeGetter(Object obj, String propertyName) {
		...
		for (String name : propertyName.split(".")) {
			String getterMethodName = GETTER_PREFIX + StrKit.capitalize(name);
	...
	public static void invokeSetter(Object obj, String propertyName, Object value) {
		...
		for (int i = 0; i < names.length; i++) {
			if (i < names.length - 1) {
				String getterMethodName = GETTER_PREFIX + StrKit.capitalize(names[i]);
				object = invokeMethod(object, getterMethodName, new Class[] {}, new Object[] {});
			} else {
				String setterMethodName = SETTER_PREFIX + StrKit.capitalize(names[i]);
	...
	public static Field getAccessibleField(final Object obj, final String fieldName) {
		StrKit.notNull(obj, "object can't be null");
		StrKit.notBlank(fieldName, "fieldName can't be blank");
	...
	public static Method getAccessibleMethod(final Object obj, final String methodName,
		...
		StrKit.notNullException(obj, "object can't be null");
		StrKit.notBlankException(methodName, "methodName can't be blank");
